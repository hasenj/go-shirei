...
func TestUpdateRejectsDuplicateIDs(t *testing.T) {
	model := Model{Menus: []Menu{{Label: "File", Items: []Item{{ID: "open", Label: "Open"}, {ID: "open", Label: "Again"}}}}}
...
func TestUpdateAcceptsNestedAndSeparatorItems(t *testing.T) {
	model := Model{Menus: []Menu{{Label: "File", Items: []Item{
		{Kind: SeparatorItem},
...
func TestCloneModelDoesNotAliasChildren(t *testing.T) {
	model := Model{Menus: []Menu{{Label: "File", Items: []Item{{Kind: SubmenuItem, Label: "Recent", Children: []Item{{ID: "one", Label: "One"}}}}}}}
