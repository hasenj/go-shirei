...
//	go run ./behavior_test/modal-nested-panel --window --drive --close
//	go run ./behavior_test/modal-nested-panel --window --drive
//	go run ./behavior_test/modal-nested-panel --window
package main
...
func frameFn() {
	...
	Container(Attrs(Viewport, Background(220, 12, 96, 1), Pad(20), Gap(12)), func() {
		...
		Label(fmt.Sprintf("modal=%v panel=%v panelRan=%v", showModal, showPanel, panelRan),
