...
//
// Same shell and VirtualLists as demos/layout-shell/step14; only the bottom
// strip changes — modern chat-style compose (ProcessTextInput + circular
// ProcessButtonEvents send). This is NOT a layout tutorial step.
//
// Tutorial: docs/custom-widgets-tutorial.md
// Base layout: docs/layout-tutorial.md (through step 14)
//
//	go run . --png out.png
package main
...
func main() {
	...
	app.SetupWindow("Custom compose (layout step 14 + chatCompose)", winW, winH)
	app.Run(frame)
}
